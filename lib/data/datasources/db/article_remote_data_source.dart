...
import 'package:application_berita_b/data/models/article_model.dart';
import 'package:application_berita_b/domain/entities/article.dart';
import 'package:application_berita_b/data/models/article_response.dart';
...
class ArticleRemoteDataSourceImpl implements ArticleRemoteDataSource {
  ...
  Future<List<ArticleModel>> getTopHeadlineArticles() async {
    // TODO: implement getTopHeadlineArticles
  ...
  Future<List<ArticleModel>> getHeadlineBusinessArticles() async {
    // TODO: implement getHeadlineBusinessArticles
    final response = await client.get(Uri.parse(
  ...
  Future<List<ArticleModel>> getArticleCategory(String category) async {
    // TODO: implement getArticleCategory
    final response = await client.get(Uri.parse(
